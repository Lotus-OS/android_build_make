...
ifeq (,$(strip $(PDK_FUSION_PLATFORM_ZIP)$(PDK_FUSION_PLATFORM_DIR)))
  ...
  _pdk_fusion_search_paths := \
    ...
    vendor/pdk/$(TARGET_DEVICE)/$(patsubst lotus_%,full_%,$(TARGET_PRODUCT))-$(TARGET_BUILD_VARIANT)/platform \
    vendor/pdk/$(TARGET_PRODUCT)/$(TARGET_PRODUCT)-$(TARGET_BUILD_VARIANT)/platform \
    vendor/pdk/$(TARGET_PRODUCT)/$(patsubst lotus_%,full_%,$(TARGET_PRODUCT))-$(TARGET_BUILD_VARIANT)/platform

...
""" % bcb_dev)
  ...
  lotus_version = target_info.GetBuildProp("ro.lotus.version")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("ro.lotus.device")

  script.Print("----------------------------------------------");
  script.Print("                   LotusOS                    ");
  script.Print("               by Nobi Nobita                 ");
  script.Print("               by Dinh San                    ");
  script.Print("               by Mrhainavn                   ");
  script.Print("----------------------------------------------");
  script.Print(" Android version: %s"%(android_version));
  script.Print(" Build id: %s"%(build_id));
  script.Print(" LotusOS version: %s"%(lotus_version));
